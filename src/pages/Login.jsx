            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center">
                                <input type="checkbox" id="remember" className="w-4 h-4 rounded border-gray-600 bg-gray-700 text-purple-600 focus:ring-purple-500/50" />
                    ...
                    <div className="mt-6">
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-2 bg-transparent text-gray-500 bg-[#0f0f0f]/0 backdrop-blur-xl">Or continue with</span>
                            </div>
                        </div>
                    ...
                    <p className="mt-8 text-center text-gray-400 text-sm">
                        ...
                        <Link to="/signup" className="text-white font-medium hover:underline decoration-purple-500 underline-offset-4">
                            Create account
                        </Link>
                    </p>
                </div>
